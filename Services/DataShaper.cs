...
namespace Services
{
    public class DataShaper<T> : IDataShaper<T> where T : class
    {
        ...
        public ExpandoObject ShapeData(T entity, string fieldString)
        {
            ...
            return FetchDateForEntity(entity, requiredProperties);
        }
        ...
        private ExpandoObject FetchDateForEntity(T entity, IEnumerable<PropertyInfo> requiredProporties)
        {
            var shapedObject=new ExpandoObject();
            foreach (var property in requiredProporties)
            {
        ...
        private IEnumerable<ExpandoObject> FetchData(IEnumerable<T> entities,IEnumerable<PropertyInfo> requiredProperties)
        {
            ...
            {
                var shapeObject = FetchDateForEntity(entity, requiredProperties);
